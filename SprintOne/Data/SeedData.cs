    ...
    public static class SeedData
    {
        ...
        public static void Initialize(MatchContext context)
        {
            ...
            if (context.Users.Any())
            {
                ...
                {
                   // UserID = 1
                   new Profile { ProfileID = 1, FirstName = "John", LastName = "Smith", CreationDate = DateTime.Parse("2019-09-24"), UserID = 1 },
                   new Profile { ProfileID = 2, FirstName = "Susan", LastName = "Meyers", CreationDate = DateTime.Parse("2019-05-07"), UserID = 2 },
                   new Profile { ProfileID = 3, FirstName = "Michael", LastName = "Boylan", CreationDate = DateTime.Parse("2019-06-17"), UserID = 3 },
                   new Profile { ProfileID = 4, FirstName = "Jeff", LastName = "Mililer", CreationDate = DateTime.Parse("2020-01-12"), UserID = 4 },
                   new Profile { ProfileID = 5, FirstName = "Karen", LastName = "Filippelli", CreationDate = DateTime.Parse("2018-03-23"), UserID = 5 },
                   // UserID = 5
                   new Profile { ProfileID = 6, FirstName = "Jim", LastName = "Halpert", CreationDate = DateTime.Parse("2019-07-05"), UserID = 6 },
                   new Profile { ProfileID = 7, FirstName = "Dwight", LastName = "Schrute", CreationDate = DateTime.Parse("2020-03-09"), UserID = 7 },
                   new Profile { ProfileID = 8, FirstName = "Pam", LastName = "Beesly", CreationDate = DateTime.Parse("2020-02-15"), UserID = 8 },
                   new Profile { ProfileID = 9, FirstName = "Kelly", LastName = "Kapoor", CreationDate = DateTime.Parse("2019-04-09"), UserID = 9 },
                   new Profile { ProfileID = 10, FirstName = "Ryan", LastName = "Howard", CreationDate = DateTime.Parse("2019-11-25"), UserID = 10 }
                };
                ...
                {
                    new Thread {ThreadID = 1, InitiatorID = 8, ReceiverID = 1 },
                    new Thread {ThreadID = 2, InitiatorID = 5, ReceiverID = 3 },
                    new Thread {ThreadID = 3, InitiatorID = 3, ReceiverID = 10 },
                    new Thread {ThreadID = 4, InitiatorID = 7, ReceiverID = 4 },
                    new Thread {ThreadID = 5, InitiatorID = 2, ReceiverID = 9 }
                };
